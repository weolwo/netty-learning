package com.owen.netty.c5;

import com.owen.config.ApplicationConfig;
import com.owen.message.LoginRequestMessage;
import com.owen.message.Message;
...
//        channel.writeOutbound(message);
    ...
    public static ByteBuf messageToByteBuf(Message msg) {
        int algorithm = ApplicationConfig.getSerializerAlgorithm().ordinal();
